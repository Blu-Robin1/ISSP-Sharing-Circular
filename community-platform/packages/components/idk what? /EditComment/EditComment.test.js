...
describe('EditComment', () => {
    ...
    it('enables save button when comment is not empty', () => {
        const screen = render(_jsx(EditComment, { isReply: false, comment: "Test comment", setShowEditModal: () => null, handleCancel: mockOnCancel, handleSubmit: mockOnSubmit }));
    ...
    it('disables save button when comment is empty', () => {
        const screen = render(_jsx(EditComment, { isReply: false, comment: "", setShowEditModal: () => null, handleCancel: mockOnCancel, handleSubmit: mockOnSubmit }));
