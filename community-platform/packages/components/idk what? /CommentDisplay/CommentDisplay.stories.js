...
const mockHandleUsefulClick = async (vote, eventCategory = 'Comment') => {
...
export const Default = () => {
    ...
    return (_jsx(CommentDisplay, { comment: comment, itemType: itemType, isEditable: isEditable, usefulButtonConfig: usefulButtonConfig, setShowDeleteModal: setShowDeleteModal, setShowEditModal: setShowEditModal }));
};
export const Editable = () => {
    const comment = fakeCommentSB();
    return (_jsx(CommentDisplay, { comment: comment, itemType: itemType, isEditable: true, usefulButtonConfig: usefulButtonConfig, setShowDeleteModal: setShowDeleteModal, setShowEditModal: setShowEditModal }));
};
export const Edited = () => {
...
export const UserVotedUseful = () => {
    ...
    return (_jsx(CommentDisplay, { comment: comment, itemType: itemType, isEditable: isEditable, usefulButtonConfig: votedConfig, setShowDeleteModal: setShowDeleteModal, setShowEditModal: setShowEditModal }));
};
