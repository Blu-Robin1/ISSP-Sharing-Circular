...
describe('UserStatistics', () => {
    ...
    it('renders correctly', () => {
        const { container } = render(_jsx(UserStatistics, { ...defaultProps }));
        expect(container).toBeTruthy();
    });
    it('renders location link when country and userName are provided', () => {
        const { getByTestId } = render(_jsx(UserStatistics, { ...defaultProps }));
    ...
    it('does not render profile views when showViews is false', () => {
        const { queryByTestId } = render(_jsx(UserStatistics, { ...defaultProps, showViews: false }));
    ...
    it('renders badges when provided', () => {
        ...
        const { getByTestId } = render(_jsx(UserStatistics, { ...propsWithBadges }));
