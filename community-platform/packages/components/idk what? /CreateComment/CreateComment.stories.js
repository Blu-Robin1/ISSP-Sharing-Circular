...
export const Default = () => {
    ...
    return (_jsx(CreateComment, { comment: comment, onChange: setComment, onSubmit: () => null, profileType: member, maxLength: 1000, isLoggedIn: true }));
};
export const LoggedOut = () => {
    const [comment, setComment] = useState('');
    return (_jsx(CreateComment, { comment: comment, onChange: setComment, onSubmit: () => null, profileType: member, maxLength: 123, isLoggedIn: false }));
};
...
Donec dapibus leo quis sagittis fringilla. Phasellus ut imperdiet sapien. Nullam posuere elementum odio, a condimentum velit. Integer diam lacus, iaculis eu faucibus eu, iaculis ac eros. Suspendisse accumsan accumsan congue. Vivamus feugiat mi quis massa convallis, sed vestibulum elit volutpat. Suspendisse in elit arcu. Cras fermentum condimentum odio, et ultrices urna auctor et. Ut orci metus, sagittis sit amet sollicitudin in, sagittis sed metus.`);
    return (_jsx(CreateComment, { comment: comment, onChange: setComment, onSubmit: () => null, profileType: member, maxLength: 12300, isLoggedIn: true }));
};
export const WithCustomPlaceholder = () => {
    const [comment, setComment] = useState('');
    return (_jsx(CreateComment, { comment: comment, placeholder: "Custom placeholder", onChange: setComment, onSubmit: () => null, profileType: member, maxLength: 12300, isLoggedIn: true }));
};
