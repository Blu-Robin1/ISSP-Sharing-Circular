...
export const fakeAuthorSB = (authorOverloads = {}) => ({
    id: faker.number.int(),
...
export const createFakeCommentsSB = (numberOfComments = 2, commentOverloads = {}) => [...Array(numberOfComments).keys()].slice(0).map(() => fakeCommentSB({
    ...commentOverloads,
}));
export const fakeCommentSB = (commentOverloads = {}) => ({
...
export const fakeNewsSB = (newsOverloads = {}) => ({
    id: faker.number.int(),
...
export const fakeDisplayNotification = (notificationOverloads = {}) => ({
    id: faker.number.int(),
...
export const fakeQuestionSB = (questionOverloads = {}) => ({
    id: faker.number.int(),
    createdAt: faker.date.past(),
    modifiedAt: null,
    author: fakeAuthorSB(),
...
export const fakeResearchItem = (researchItemOverloads = {}) => ({
    id: faker.number.int(),
    createdAt: faker.date.past(),
    modifiedAt: null,
    author: fakeAuthorSB(),
...
export const fakeResearchUpdate = (researchItemOverloads = {}) => ({
    id: faker.number.int(),
    createdAt: faker.date.past(),
    modifiedAt: null,
    author: fakeAuthorSB(),
...
export const fakeProfileType = (profileTypeOverLoads = {}) => ({
    id: faker.number.int(),
    description: '',
    displayName: '',
...
export const fakePinProfile = (pinProfileOverLoads = {}) => ({
    id: faker.number.int(),
    about: '',
    country: faker.location.country(),
    coverImages: null,
