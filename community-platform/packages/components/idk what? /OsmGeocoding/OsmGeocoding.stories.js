...
export const Default = () => _jsx(OsmGeocoding, { loading: false });
export const Loading = () => _jsx(OsmGeocoding, { loading: true });
export const ResultsList = () => (_jsx(OsmGeocodingResultsList, { results: [
        {
            place_id: 282375433,
        ...
        },
        {
            ...
            lat: '53.0326201',
            lon: '5.6518895',
            display_name: 'Sneek, Doctor Boumaweg, Sneek, Súdwest-Fryslân, Frisia, Netherlands, 8601GG, Netherlands',
            class: 'railway',
            type: 'station',
    ...
    ], callback: undefined, setShowResults: () => null }));
